...
public class RecolourImageLatencyImprove {
	
    public static final String SOURCE_FILE = "./resources/latencyres/orgflower.jpg";
    public static final String DESTINATION_FILE = "./out/latencyout/modifiedflower.jpg";
